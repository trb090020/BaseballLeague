...
<html>
	...
	<body>
		...
		<div class="login">
			...
			?>
			<br><hr size="1" width="100%" color="black">
			...
			<p class="text"><b>Statistics For Last 10 Games:</b><?php &nbsp; echo $pitchername;&nbsp;?><b>vs.</b> <?php &nbsp;echo $team;?></p>
			<section>
					<!-- TABLE CONSTRUCTION-->
					<table class="center">
						<tr>
				...
				<p class="text"><b>Statistics For Last 5 Games:</b><?php &nbsp; echo $pitchername;&nbsp;?><b>vs.</b> <?php &nbsp;echo $team;?></p>
				<section>
					<!-- TABLE CONSTRUCTION-->
					<table class="center">
						<tr>
				...
				<p class="text"><b>All At Bat Records:</b><?php &nbsp; echo $pitchername;&nbsp;?><b>vs.</b> <?php &nbsp;echo $team;?></p>
				<section>
					<!-- TABLE CONSTRUCTION-->
					<table class="center">
						<tr>
